...
class AppColors {
  ...
  // Brand: "Signal Teal" — the single, ownable primary hue (see
  // brand/tokens/brand-tokens.json). Replaces the former split between a generic
  // Tailwind blue and the indigo "glow"; success moved teal→green so semantic
  // green no longer collides with the brand teal.
  static const Color primary = Color(0xFF0B7884);
  static const Color secondary = Color(0xFF0E6E84);
